...
// Implementing the `commet.Plugin` interface so it can be run by the runtime
...
func (s *pluginRegistrar) GetBrokerType() commet.BrokerType {
	return s.brokerType
}

func (s *pluginRegistrar) RegisterPublisher(broker interface{}) error {
	if broker == nil {
