...
// non-positive. The catalog is expected to stay small (see the Foundry
...
// questions, Foundry only ever resolves an exact pin — no version-range
// matching.
...
// plan notes on Foundry's scale); it avoids the "page shifts under you while
