module github.com/steady-bytes/draft/services/tooling/foundry
...
// chassis.Effect (see pkg/chassis/effect.go), which WithRepository is built on but
// which hasn't been published yet — mirrors services/core/heartbeat/go.mod.
