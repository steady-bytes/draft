...
const (
	testContainerName = "foundry-plugincatalog-test-postgres"
	testPostgresPort  = "55437"
	testDSN           = "postgres://foundry_test:foundry_test@localhost:" + testPostgresPort + "/foundry_test?sslmode=disable"
)
...
func runTestMain(m *testing.M) int {
	...
	startCmd := exec.Command("docker", "run", "-d",
		...
		"-e", "POSTGRES_USER=foundry_test",
		"-e", "POSTGRES_PASSWORD=foundry_test",
		"-e", "POSTGRES_DB=foundry_test",
