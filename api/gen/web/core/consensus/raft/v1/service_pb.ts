...
// @generated from file core/consensus/raft/v1/service.proto (package consensus.raft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class JoinRequest extends Message<JoinRequest> {
  ...
  static readonly typeName = "consensus.raft.v1.JoinRequest";
...
export class JoinResponse extends Message<JoinResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.JoinResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "node_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "raft_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class RemoveRequest extends Message<RemoveRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.RemoveRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "node_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class RemoveResponse extends Message<RemoveResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.RemoveResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "node_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class StatsRequest extends Message<StatsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.StatsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "node_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class StatsResponse extends Message<StatsResponse> {
  ...
  /**
   * @generated from field: consensus.raft.v1.Stats stats = 2;
   */
  stats?: Stats;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.StatsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "node_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class Stats extends Message<Stats> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "consensus.raft.v1.Stats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
