...
export enum Operation {
  /**
   * @generated from enum value: NullOperation = 0;
   */
  NullOperation = 0,
...
proto3.util.setEnumType(Operation, "consensus.fsm.v1.Operation", [
...
export class CommandPayload extends Message<CommandPayload> {
  /**
   * @generated from field: consensus.fsm.v1.Operation operation = 1;
   */
  operation = Operation.NullOperation;
  ...
  static readonly typeName = "consensus.fsm.v1.CommandPayload";
