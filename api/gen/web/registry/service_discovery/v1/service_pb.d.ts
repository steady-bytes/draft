...
export class InitRequest extends jspb.Message {
  ...
  getPeerId(): string;
  setPeerId(value: string): InitRequest;
...
export class InitResponse extends jspb.Message {
  getServiceId(): string;
  setServiceId(value: string): InitResponse;

  getRegistryAddress(): string;
  setRegistryAddress(value: string): InitResponse;

  getToken(): Token | undefined;
  setToken(value?: Token): InitResponse;
  hasToken(): boolean;
  clearToken(): InitResponse;
