...
// @generated from file test/hello_world/v1/service.proto (package test.hello_world.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message test.hello_world.v1.HelloRequest
 */
export class HelloRequest extends Message<HelloRequest> {
  ...
  static readonly typeName = "test.hello_world.v1.HelloRequest";
...
/**
 * @generated from message test.hello_world.v1.HelloResponse
 */
export class HelloResponse extends Message<HelloResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "test.hello_world.v1.HelloResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
