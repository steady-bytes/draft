...
type StartupConfiguration struct {
	...
	AssignedPort uint32 `protobuf:"varint,1,opt,name=assigned_port,json=assignedPort,proto3" json:"assigned_port" pg:"assigned_port" bun:"assigned_port" yaml:"assigned_port" csv:"assigned_port"`
}
...
type Process struct {
	...
	JoinedTime     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=joined_time,json=joinedTime,proto3" json:"joined_time" yaml:"joined_time" csv:"joined_time" pg:"joined_time" bun:"joined_time"`
	...
	HealthState    ProcessHealthState     `protobuf:"varint,13,opt,name=health_state,json=healthState,proto3,enum=registry.service_discovery.v1.ProcessHealthState" json:"health_state" bun:"health_state" yaml:"health_state" csv:"health_state" pg:"health_state"`
...
type GeoPoint struct {
	...
	Lat float32 `protobuf:"fixed32,1,opt,name=lat,proto3" json:"lat" csv:"lat" pg:"lat" bun:"lat" yaml:"lat"`
...
var file_core_registry_service_discovery_v1_models_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	...
	0x43, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x07, 0x20, 0x03, 0x28,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x43, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x6f, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52,
	0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x0b, 0x6a, 0x6f, 0x69,
	...
	0x73, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x57, 0x0a, 0x0d, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x32, 0x2e, 0x72,
	...
	0x52, 0x0c, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x54,
	0x0a, 0x0c, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0d,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x31, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72,
	...
	0x74, 0x61, 0x74, 0x65, 0x12, 0x3a, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x0e, 0x20,
	...
	0x22, 0x44, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x10, 0x0a, 0x03,
	...
	,
	...
	0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x02, 0x42, 0x46, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x65, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x62,
...
var file_core_registry_service_discovery_v1_models_proto_goTypes = []interface{}{
	...
	(*StartupConfiguration)(nil),  // 5: registry.service_discovery.v1.StartupConfiguration
	(*Process)(nil),               // 6: registry.service_discovery.v1.Process
	(*Metadata)(nil),              // 7: registry.service_discovery.v1.Metadata
	(*GeoPoint)(nil),              // 8: registry.service_discovery.v1.GeoPoint
	(*Token)(nil),                 // 9: registry.service_discovery.v1.Token
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_core_registry_service_discovery_v1_models_proto_depIdxs = []int32{
	9,  // 0: registry.service_discovery.v1.ProcessIdentity.token:type_name -> registry.service_discovery.v1.Token
	0,  // 1: registry.service_discovery.v1.Process.process_kind:type_name -> registry.service_discovery.v1.ProcessKind
	7,  // 2: registry.service_discovery.v1.Process.metadata:type_name -> registry.service_discovery.v1.Metadata
	8,  // 3: registry.service_discovery.v1.Process.location:type_name -> registry.service_discovery.v1.GeoPoint
	10, // 4: registry.service_discovery.v1.Process.joined_time:type_name -> google.protobuf.Timestamp
	10, // 5: registry.service_discovery.v1.Process.left_time:type_name -> google.protobuf.Timestamp
	10, // 6: registry.service_discovery.v1.Process.last_status_time:type_name -> google.protobuf.Timestamp
	...
	9,  // 9: registry.service_discovery.v1.Process.token:type_name -> registry.service_discovery.v1.Token
...
func file_core_registry_service_discovery_v1_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_registry_service_discovery_v1_models_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Zone); i {
			case 0:
				return &v.state
			case 1:
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_registry_service_discovery_v1_models_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Token); i {
			case 0:
				return &v.state
			case 1:
