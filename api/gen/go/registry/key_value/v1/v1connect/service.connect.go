...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/steady-bytes/draft/api/gen/go/registry/key_value/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	KeyValueServiceName = "registry.key_value.v1.KeyValueService"
)
...
const (
	...
	KeyValueServiceSetProcedure = "/registry.key_value.v1.KeyValueService/Set"
...
var (
	keyValueServiceServiceDescriptor      = v1.File_registry_key_value_v1_service_proto.Services().ByName("KeyValueService")
...
// Get calls registry.key_value.v1.KeyValueService.Get.
...
// Delete calls registry.key_value.v1.KeyValueService.Delete.
...
func (UnimplementedKeyValueServiceHandler) Set(context.Context, *connect.Request[v1.SetRequest]) (*connect.Response[v1.SetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("registry.key_value.v1.KeyValueService.Set is not implemented"))
}
...
func (UnimplementedKeyValueServiceHandler) Get(context.Context, *connect.Request[v1.GetRequest]) (*connect.Response[v1.GetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("registry.key_value.v1.KeyValueService.Get is not implemented"))
}
