...
type UserClient interface {
	...
	Get(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*UserDetails, error)
}
...
func (c *userClient) Get(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*UserDetails, error) {
	out := new(UserDetails)
...
type UserServer interface {
	...
	Get(context.Context, *UserID) (*UserDetails, error)
...
func (UnimplementedUserServer) Get(context.Context, *UserID) (*UserDetails, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/draft/authentication/v1/user.proto",
}
