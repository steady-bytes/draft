...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/steady-bytes/draft/api/gen/go/consensus/raft/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	RaftServiceName = "consensus.raft.v1.RaftService"
)
...
const (
	...
	RaftServiceJoinProcedure = "/consensus.raft.v1.RaftService/Join"
	// RaftServiceRemoveProcedure is the fully-qualified name of the RaftService's Remove RPC.
	RaftServiceRemoveProcedure = "/consensus.raft.v1.RaftService/Remove"
	// RaftServiceStatsProcedure is the fully-qualified name of the RaftService's Stats RPC.
	RaftServiceStatsProcedure = "/consensus.raft.v1.RaftService/Stats"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	raftServiceServiceDescriptor      = v1.File_consensus_raft_v1_service_proto.Services().ByName("RaftService")
...
// RaftServiceClient is a client for the consensus.raft.v1.RaftService service.
...
// NewRaftServiceClient constructs a client for the consensus.raft.v1.RaftService service. By
...
// Join calls consensus.raft.v1.RaftService.Join.
...
// Remove calls consensus.raft.v1.RaftService.Remove.
...
// Stats calls consensus.raft.v1.RaftService.Stats.
...
// RaftServiceHandler is an implementation of the consensus.raft.v1.RaftService service.
...
func NewRaftServiceHandler(svc RaftServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/consensus.raft.v1.RaftService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRaftServiceHandler) Join(context.Context, *connect.Request[v1.JoinRequest]) (*connect.Response[v1.JoinResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("consensus.raft.v1.RaftService.Join is not implemented"))
}
...
func (UnimplementedRaftServiceHandler) Remove(context.Context, *connect.Request[v1.RemoveRequest]) (*connect.Response[v1.RemoveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("consensus.raft.v1.RaftService.Remove is not implemented"))
}
...
func (UnimplementedRaftServiceHandler) Stats(context.Context, *connect.Request[v1.StatsRequest]) (*connect.Response[v1.StatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("consensus.raft.v1.RaftService.Stats is not implemented"))
}
