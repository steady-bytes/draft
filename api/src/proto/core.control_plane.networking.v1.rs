...
pub struct ValidateRouteRequest {
    ...
    #[prost(string, tag = "2")]
    pub existing_name: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct Route {
    ...
    pub mtls: ::core::option::Option<MtlsPolicy>,
}
...
pub struct MtlsPolicy {
    ...
    #[prost(string, tag = "2")]
    pub trusted_ca_secret_name: ::prost::alloc::string::String,
}
