...
// Validate checks the field values on GetClusterDetailsRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetClusterDetailsRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetClusterDetailsRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetClusterDetailsRequestMultiError, or nil if none found.
func (m *GetClusterDetailsRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetClusterDetailsRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetClusterDetailsRequestMultiError(errors)
	}

	return nil
}

// GetClusterDetailsRequestMultiError is an error wrapping multiple validation
// errors returned by GetClusterDetailsRequest.ValidateAll() if the designated
// constraints aren't met.
type GetClusterDetailsRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetClusterDetailsRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetClusterDetailsRequestMultiError) AllErrors() []error { return m }

// GetClusterDetailsRequestValidationError is the validation error returned by
// GetClusterDetailsRequest.Validate if the designated constraints aren't met.
type GetClusterDetailsRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetClusterDetailsRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetClusterDetailsRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetClusterDetailsRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetClusterDetailsRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetClusterDetailsRequestValidationError) ErrorName() string {
	return "GetClusterDetailsRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetClusterDetailsRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetClusterDetailsRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetClusterDetailsRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetClusterDetailsRequestValidationError{}
