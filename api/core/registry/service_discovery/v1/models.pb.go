...
type Process struct {
	...
	ProcessKind    ProcessKind            `protobuf:"varint,6,opt,name=process_kind,json=processKind,proto3,enum=core.registry.service_discovery.v1.ProcessKind" json:"process_kind" csv:"process_kind" pg:"process_kind" bun:"process_kind" yaml:"process_kind"`
	...
	LastStatusTime *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=last_status_time,json=lastStatusTime,proto3" json:"last_status_time" yaml:"last_status_time" csv:"last_status_time" pg:"last_status_time" bun:"last_status_time"`
	...
	HealthState    ProcessHealthState     `protobuf:"varint,13,opt,name=health_state,json=healthState,proto3,enum=core.registry.service_discovery.v1.ProcessHealthState" json:"health_state" yaml:"health_state" csv:"health_state" pg:"health_state" bun:"health_state"`
