...
type StartupConfiguration struct {
	...
	AssignedPort uint32 `protobuf:"varint,1,opt,name=assigned_port,json=assignedPort,proto3" json:"assigned_port" bun:"assigned_port" yaml:"assigned_port" csv:"assigned_port" pg:"assigned_port"`
}
...
type Process struct {
	...
	RunningState   ProcessRunningState    `protobuf:"varint,12,opt,name=running_state,json=runningState,proto3,enum=core.registry.service_discovery.v1.ProcessRunningState" json:"running_state" yaml:"running_state" csv:"running_state" pg:"running_state" bun:"running_state"`
