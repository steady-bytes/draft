...
const file_core_message_broker_actors_v1_models_proto_rawDesc = "" +
	"\n" +
	...
	"\x06events\x18\x01 \x03(\v2).core.message_broker.actors.v1.CloudEventR\x06eventsBAZ?github.com/steady-bytes/draft/api/core/message_broker/actors/v1b\x06proto3"

var (
	file_core_message_broker_actors_v1_models_proto_rawDescOnce sync.Once
	file_core_message_broker_actors_v1_models_proto_rawDescData []byte
)
...
func file_core_message_broker_actors_v1_models_proto_rawDescGZIP() []byte {
	file_core_message_broker_actors_v1_models_proto_rawDescOnce.Do(func() {
		file_core_message_broker_actors_v1_models_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_message_broker_actors_v1_models_proto_rawDesc), len(file_core_message_broker_actors_v1_models_proto_rawDesc)))
	})
...
func file_core_message_broker_actors_v1_models_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_core_message_broker_actors_v1_models_proto_rawDesc), len(file_core_message_broker_actors_v1_models_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
